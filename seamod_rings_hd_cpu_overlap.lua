--[[===========================================================================
Example for 15.6" HD screen with 100% font scaling, overlapped CPU threads
...
-- Siblings 0,6 (cpu1,cpu7)
{
    ...
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.04,
    graph_fg_colour=0xFFFFFF,      graph_fg_alpha=0.25,
    ...
    graduation_fg_colour=0xFFFFFF, graduation_fg_alpha=0.25,
    caption='0:6',
